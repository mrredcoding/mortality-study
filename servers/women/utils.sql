...
-- Example:
CALL get_avg_mortality_rate('mortality_rate_women_from41to65', 0, NULL);
...
-- Example:
CALL get_avg_life_expectancy('mortality_rate_women_from41to65', 0, NULL);
...
-- Example:
CALL get_max_mortality_rate('mortality_rate_women_from41to65', 0, NULL, NULL);
