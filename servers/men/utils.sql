...
-- Example:
SELECT * FROM get_avg_mortality_rate('mortality_rate_men_from41to65',0)
...
-- Example:
SELECT * FROM get_avg_life_expectancy('mortality_rate_men_from41to65',0)
...
-- Example:
SELECT * FROM get_max_mortality_rate('mortality_rate_men_from41to65',0)
